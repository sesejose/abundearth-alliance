  ...
  return (
    <section id="about" className="relative">
      <div className="py-12 md:py-24 bg-stone-800">
        <div className="max-w-full mx-auto px-4 flex flex-wrap gap-x-24 md:px-4 lg:px-40">
          {/* Section header */}
          <div className="max-w-full mx-auto md:px-4 lg:px-80 sm:text-left md:text-center pb-12 md:pb-16 ">
          ...
          <div className="grid gap-8 md:gap-20">
            {/* 1st item */}
            <div className="relative grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-12 grid-rows-1 gap-8 md:gap-20 items-center">
              {/* Content */}
              <div className="sm:col-span-1 md:col-span-1 lg:col-span-6 sm:col-start-1 md:col-start-1 lg:col-start-1 mb-8 md:mb-0" data-aos="fade-right">
                <div className="">
              ...
              {/* Image */}
              <div className="sm:col-span-1 md:col-span-1 lg:col-span-6 sm:col-start-1 md:col-start-2 lg:col-start-7 mb-8 md:mb-0" data-aos="fade-up">
                <Image className="min-w-full mx-auto md:max-w-auto lg:max-w-none h-auto" src={bghero} width={540} height={405} alt="Features 01" />
              </div>
            </div>
            ...
            <div className="relative grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-12 grid-rows-1 gap-8 md:gap-20 items-center">
              {/* Image */}
              <div className="sm:col-span-1 md:col-span-1 lg:col-span-6 sm:col-start-1 md:col-start-1 lg:col-start-1 mb-8 md:mb-0 rtl order-2 md:order-1" data-aos="fade-up">
                <Image className="min-w-full mx-auto md:max-w-auto lg:max-w-none h-auto" src={bghero} width={540} height={405} alt="Features 02" />
              </div>
              {/* Content */}
              <div className="sm:col-span-1 md:col-span-1 lg:col-span-6 sm:col-start-1 md:col-start-2 lg:col-start-7 order-1 md:order-2" data-aos="fade-left">
                <div className="">
