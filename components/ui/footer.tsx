      ...
      <div className="py-12 md:py-16 bg-gray-900 border-t border-gray-800">
        <div className="max-w-full mx-auto px-4 sm:px-6 md:px-40">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="flex items-center" aria-label="Cruip">
                  ...
                  <div className="text-lg font-semibold text-amber-600 font-notosans">Abound Alliance</div>
                </Link>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-300 text-sm mr-4">&copy; Abound Alliance. All rights reserved.</div>
          </div>
        </div>
      </div>
    </footer>
