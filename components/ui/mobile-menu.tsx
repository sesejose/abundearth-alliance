  ...
  return (
    <div className="md:hidden">
      ...
      <button ref={trigger} className={`hamburger ${mobileNavOpen && "active"}`} aria-controls="mobile-nav" aria-expanded={mobileNavOpen} onClick={() => setMobileNavOpen(!mobileNavOpen)}>
        ...
        <svg className="w-6 h-6 fill-current text-amber-600 hover:text-amber-800 transition duration-150 ease-in-out" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <ul className="bg-amber-50 px-4 py-10">
          ...
          {/* <li>
                <Link href="#services" className="font-medium text-amber-800 hover:text-amber-600 px-4 py-3 flex items-center transition duration-150 ease-in-out">
                  What we offer
                </Link>
              </li> */}
          <li>
